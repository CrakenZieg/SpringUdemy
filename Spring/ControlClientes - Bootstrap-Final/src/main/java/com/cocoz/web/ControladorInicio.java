...
40. Agregamos la libreria de bootstrap y font-awesome al pom, tambien webjars-locator.

41. Agregamos stylesheets y script a los head de los html mediante un fragment declarado
en plantilla. Los path a tienen como raiz webjars.

42. Tuve que agregar popper y jquery, bundle de bootstrap no funcionaba. Se sumaron
a los links del head y al pom.
*/
